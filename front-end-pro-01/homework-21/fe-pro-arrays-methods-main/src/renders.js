...
`;
  ...
  const rangeMinPrice = reducers.minPriceReducer().price;
  const rangeMaxPrice = reducers.maxPriceReducer().price;
  console.log(rangeMinPrice, rangeMaxPrice);
  const rangeTo = document.querySelector('label:last-child input[type=range]');
  rangeFrom.setAttribute('min', rangeMinPrice.toString());
  rangeFrom.setAttribute('max', rangeMaxPrice.toString());
  rangeFrom.value = rangeMinPrice;
  rangeTo.setAttribute('min', rangeMinPrice.toString());
  rangeTo.setAttribute('max', rangeMaxPrice.toString());
  rangeTo.value = rangeMaxPrice;
